...
$lin = substr($actual_link, $rrr);
    ...
    switch($lang) {
        ...
        case 'es':
            ...
            $TEXT_1="Be the first to see the world's best and most popular TV shows."; 
            $TEXT_2="¡Deprisa! ¡Esta oferta caduca pronto55454!";
            ...
            $TEXT_12="CREATE YOUR ACCOUNT";
       

            $TEXT_13="Solo";
            $TEXT_14="You're one step closer to the best entertainment Netflix has to offer";
